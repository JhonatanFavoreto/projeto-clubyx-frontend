        ...
        <div className="simulados-page">
            ...
            <main className="content">
                ...
                <h4 className="texto-formatado">
                    {questoes[2]?.enunciado || 'Enunciado indisponivel no momento.'}
                </h4>

                <div className="options">
                    <button
                        onClick={() => handleAlternativaClick(2, 0)}
                        className={`${
                            respostas[2]?.index === 0
                                ? respostas[2]?.correta
                                    ? 'correcta'
                        ...
                        disabled={!!respostas[2]}>
                        {questoes[2]?.alternativas?.[0]?.texto ||
                            'Enunciado indisponível no momento.'}
                    </button>
                    <button
                        onClick={() => handleAlternativaClick(2, 1)}
                        className={`${
                            respostas[2]?.index === 1
                                ? respostas[2]?.correta
                                    ? 'correcta'
                        ...
                        disabled={!!respostas[2]}>
                        {questoes[2]?.alternativas?.[1]?.texto ||
                            'Enunciado indisponível no momento.'}
                    </button>
                    <button
                        onClick={() => handleAlternativaClick(2, 2)}
                        className={`${
                            respostas[2]?.index === 2
                                ? respostas[2]?.correta
                                    ? 'correcta'
                        ...
                        disabled={!!respostas[2]}>
                        {questoes[2]?.alternativas?.[2]?.texto ||
                            'Enunciado indisponível no momento.'}
                    </button>
                    <button
                        onClick={() => handleAlternativaClick(2, 3)}
                        className={`${
                            respostas[2]?.index === 3
                                ? respostas[2]?.correta
                                    ? 'correcta'
                        ...
                        disabled={!!respostas[2]}>
                        {questoes[2]?.alternativas?.[3]?.texto ||
                            'Enunciado indisponível no momento.'}
                    </button>
                </div>
