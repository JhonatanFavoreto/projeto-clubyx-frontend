        ...
        <>
          <section className="hero-section" id="home">
            ...
            <p className="hero-subtitle">
              "Ao verme que primeiro roeu as frías carnes do meu cadáver dedico
          ...
          <section className="secao-tecnologia" id="obra">
            ...
            <p>
              O Clube do Livro é uma plataforma digital colaborativa que nasce
              da união entre tecnologia e literatura. Desenvolvido em parceria
              pelos alunos de Desenvolvimento de Sistemas (SENAI) e as áreas de
              Língua Portuguesa e Inglês (SESI), nosso objetivo principal é
              transformar e facilitar a preparação para os vestibulares.
            </p>

            <p>
              Através de um ambiente interativo e totalmente bilíngue,
              oferecemos análises literárias, simulados e conteúdos multimídia
              focados nos maiores clássicos nacionais. É uma ferramenta
              inovadora construída de alunos para alunos, promovendo o
              aprendizado interdisciplinar e o trabalho em equipe.
            </p>
          </section>
          ...
          <section className="secao-projeto">
            ...
            <p>
              Esta plataforma digital colaborativa foi desenvolvida pelas turmas
              de Desenvolvimento de Sistemas (SENAI) em parceria com Língua
              Portuguesa e Inglês (SESI). Nosso objetivo principal é unir
              tecnologia e literatura para create uma ferramenta bilíngue e
              auxiliar os estudantes na preparação para os vestibulares,
